...
import { changeVolume, updateDisplay, switchBank , switchPower } from '../redux/action/index';

class AppMachine extends Component{
    constructor(props){
      super(props);
...
export default connect(mapStateToProps, mapDispatchToProps)(AppMachine);